...
const fragmentShader = `
  ...
  float lambertLight(vec3 normal, vec3 lightPos){
  ...
  void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    float lambert = pow(lambertLight(n, lpos), 2.);
...
export const Shader3 = ({ color = "#4d9eff", style }) => {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, width: "100%", height: "100%", zIndex: -1, ...style }}>
      <Canvas>
